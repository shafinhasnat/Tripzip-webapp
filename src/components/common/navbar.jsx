  ...
  return (
    <div style={{ paddingBottom: "0px" }}>
      <nav className="navbar navbar-expand-lg navbar-light bg-light">
        ...
        >
          {auth ? (
            <Link to="/mingle" className="nav-item nav-link">
              Mingle <span className="sr-only">(current)</span>
            </Link>
          ) : (
            <div>
              <Link className="nav-item nav-link" onClick={openModal}>
                Mingle <span className="sr-only">(current)</span>
              </Link>
              <toggleModal />
            </div>
        ...
        {auth ? (
          ...
          <div>
            <img
              src="https://i.ibb.co/v40WF0t/no-photo.jpg"
              className="rounded-circle"
              style={{
                float: "right",
                position: "absolute",
